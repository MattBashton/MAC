...
shinyUI(fluidPage(theme = shinytheme("united"),
                  ...
                  sidebarLayout(
                    ...
                    sidebarPanel( # all the UI controls go in here
                      ...
                      "Download test data to try classifier:", a(href="test_set.zip", "Test ZIP file", target="_blank"), helpText("Array processing and classification takes ~70 seconds for this test set of 24 arrays")
                    ), # End sidebarPanel
                    ...
                    mainPanel( # all of the output elements go here
                      tabsetPanel(
                        ...
                        tabPanel('Sample QC', br(), p(), textOutput("fs"), br(), textOutput("fc"), br(), "Table below shows the number of missing values for each Array:", br(), p(), dataTableOutput('NA_table'), br()),
